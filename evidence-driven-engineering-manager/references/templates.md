...
| ID | Scenario | Scope | Criterion | Expected | Actual | Verdict | Evidence path | SHA-256 |
|---|---|---|---|---|---|---|---|---|
...
```text
Review window:
Applicable user requirements:

| Member | End-state goal | Actual work | Current work | Quantified evidence | Closure layer | Reference comparison | General algorithm | Hourly ledger | Reasonableness | Waste/risk | User intervened | Manager action | Score |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---:|

Confirmed facts:
Unchecked member statements:
Manager judgments:
Unknowns:
Three-attempt fuse state:
User-attended experiment queue:
History capacity and action:
Manager self-score and correction:
Next review focus:
```
